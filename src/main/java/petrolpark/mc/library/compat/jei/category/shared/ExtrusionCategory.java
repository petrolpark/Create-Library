...
import petrolpark.mc.library.compat.jei.JEIBlockRenderer;
...
public class ExtrusionCategory extends PetrolparkRecipeCategory<ExtrusionRecipe> implements ISharedFeature {
    ...
    public void draw(@Nonnull ExtrusionRecipe recipe, @Nonnull IRecipeSlotsView recipeSlotsView, @Nonnull GuiGraphics graphics, double mouseX, double mouseY) {
        ...
        blockRenderer.renderBlock(SharedCreateBlocks.EXTRUSION_DIE.getDefaultState().setValue(BlockStateProperties.AXIS, Axis.Z), graphics, 24);
        ms.popPose();;
    };

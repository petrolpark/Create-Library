...
public class MeshBasinScenes {
     ...
     */
    public static ItemLike toFry = SharedItems.RAW_FRIES;
    public static Supplier<FluidStack> fryingFluid = () -> new FluidStack(SharedCreateFluids.SUNFLOWER_OIL.get(), 1000);
    public static ItemLike fried = SharedItems.FRIES;
    ...
    public static Supplier<FluidStack> juicedFluid = () -> new FluidStack(SharedCreateFluids.SUNFLOWER_OIL.get(), 1000);

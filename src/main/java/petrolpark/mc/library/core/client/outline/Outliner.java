package petrolpark.mc.library.core.client.outline;

import java.util.Map;

import petrolpark.mc.library.mixin.compat.create.accessor.client.OutlineEntryAccessor;
import petrolpark.mc.library.mixin.compat.create.accessor.client.OutlinerAccessor;

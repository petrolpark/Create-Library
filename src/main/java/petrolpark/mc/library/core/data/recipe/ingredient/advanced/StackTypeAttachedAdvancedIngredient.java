...
// package petrolpark.mc.library.core.recipe.ingredient.advanced;
...
// public record StackTypeAttachedAdvancedIngredient<STACK, STACK_TYPE, INGREDIENT extends ITypelessAdvancedIngredient<? super STACK_TYPE>>(INGREDIENT untypedIngredient, IStackAdvancedIngredientType<STACK, STACK_TYPE> type) implements IAdvancedIngredient<STACK>, IForcingItemAdvancedIngredient {

//     @Override
//     public boolean test(STACK stack) {
//         return untypedIngredient().test(type().stack);
//     };

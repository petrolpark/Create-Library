...
public class PlayerWishList extends AbstractWishList {
    ...
    public static final Codec<Map<IAdvancedIngredient<ItemStack>, Integer>> CODEC = Codec.unboundedMap(ItemAdvancedIngredient.CODEC, Codec.INT);
    public static final IAttachmentSerializer<Tag, PlayerWishList> SERIALIZER = new Serializer();

    protected final Player player;
    protected final Object2IntMap<IAdvancedIngredient<ItemStack>> wishes = new Object2IntOpenHashMap<>();
    ...
    public PlayerWishList(IAttachmentHolder attachmentHolder, Map<IAdvancedIngredient<ItemStack>, Integer> wishes) {
    ...
    @Override
    public Collection<IAdvancedIngredient<ItemStack>> getWishes() {
        return wishes.keySet();
    };

    @Override
    public int getWishInstanceCount(IAdvancedIngredient<ItemStack> wish, int maxFulfillments) {
        return Math.min(maxFulfillments, wishes.getInt(wish));
    };

    @Override
    public void fulfillWish(IAdvancedIngredient<ItemStack> wish, ItemStack stack) {

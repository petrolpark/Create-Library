...
public record FluidTagEmptyCondition(TagKey<Fluid> tag) implements ICondition {
    ...
    public static final MapCodec<FluidTagEmptyCondition> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
    ...
    @Override
    public boolean test(@Nonnull ICondition.IContext context) {
        return context.getTag(tag).isEmpty();
    };

    @Override
    public MapCodec<FluidTagEmptyCondition> codec() {
        return PetrolparkDataLoadingConditions.FLUID_TAG_EMPTY.get();
    };

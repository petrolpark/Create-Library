...
import petrolpark.mc.library.core.world.entity.player.team.everybody.EverybodyTeam;
...
public class PetrolparkTeamProviderTypes {
    ...
    EVERYBODY = REGISTRATE.teamProviderType("everybody", MapCodec.unit(EverybodyTeam.Provider.INSTANCE), StreamCodec.unit(EverybodyTeam.Provider.INSTANCE)),

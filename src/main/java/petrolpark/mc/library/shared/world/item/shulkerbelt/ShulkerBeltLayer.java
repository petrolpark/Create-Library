package petrolpark.mc.library.shared.world.item.shulkerbelt;
...
public class ShulkerBeltLayer<T extends LivingEntity, M extends EntityModel<T>> extends RenderLayer<T, M> {
    ...
    static {
        WEARING_PREDICATES.add(player -> SharedItems.SHULKER_BELT.isIn(player.getItemBySlot(EquipmentSlot.LEGS)));
    };
    ...
    public ShulkerBeltLayer(RenderLayerParent<T, M> renderer, ItemRenderer itemRenderer) {
        ...
        beltStackInstance = SharedItems.SHULKER_BELT.asStack();
    };

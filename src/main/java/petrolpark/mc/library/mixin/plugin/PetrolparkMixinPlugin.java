package petrolpark.mc.library.mixin.plugin;
...
public class PetrolparkMixinPlugin implements IMixinConfigPlugin {
    ...
    protected String getMixinPackage() {
        return "petrolpark.mc.library.mixin";
    };
    ...
    public void onLoad(String mixinPackage) {
        requireMultipleMods("client.BasinCategoryMixin", "jei", "create");
        requireMultipleMods("client.ForgePluginFinderMixin", "jei", "create");
        requireMultipleMods("client.CreateRecipeCategoryMixin", "jei", "create");
    };

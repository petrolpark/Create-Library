...
import com.petrolpark.core.data.recipe.ingredient.advanced.EnchantmentItemAdvancedIngredient;
import com.petrolpark.core.data.recipe.ingredient.advanced.FlaggedAdvancedIngredient;
import com.petrolpark.core.data.recipe.ingredient.advanced.GenericAdvancedIngredientType;
import com.petrolpark.core.data.recipe.ingredient.advanced.HolderSetFluidAdvancedIngredient;
import com.petrolpark.core.data.recipe.ingredient.advanced.HolderSetItemAdvancedIngredient;
...
import com.petrolpark.core.data.recipe.ingredient.advanced.ItemIDRegExAdvancedIngredient;
import com.petrolpark.core.data.recipe.ingredient.advanced.ItemItemAdvancedIngredient;
import com.petrolpark.core.data.recipe.ingredient.advanced.NotAdvancedIngredient;
import com.petrolpark.core.data.recipe.ingredient.advanced.PassAdvancedIngredient;
import com.petrolpark.core.data.recipe.ingredient.advanced.TagItemAdvancedIngredient;

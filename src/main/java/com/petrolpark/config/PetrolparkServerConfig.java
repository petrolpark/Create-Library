...
public class PetrolparkServerConfig extends ConfigBase {
    ...
    public final ConfigGroup compatibility = group(0, "compatibility");
        ...
        public final ConfigGroup create = group(1, "create");
            public final ConfigBool createArmsTargetChainConveyors = b(false, "armsTargetChainConveyors", "[EXPERIMENTAL]", "Whether Mechanical Arms can take from and place on Chain Conveyors");

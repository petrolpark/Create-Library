...
public class PetrolparkDataComponents {
    ...
    public static final DataComponentType<Holder<Shop>> SHOP = register("shop", builder -> builder
        .persistent(Shop.CODEC)
        .networkSynchronized(Shop.STREAM_CODEC)
    );
    ...
    public static final DataComponentType<ShopsData> TEAM_SHOPS = register("team_shops", builder -> builder
        .persistent(ShopsData.CODEC)
    );

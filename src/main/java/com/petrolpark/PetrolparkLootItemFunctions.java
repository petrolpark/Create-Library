...
public class PetrolparkLootItemFunctions {
    ...
    public static final RegistryEntry<LootItemFunctionType<?>, LootItemFunctionType<FlagsLootItemFunction>> FLAGS = REGISTRATE.lootItemFunctionType("flag", FlagsLootItemFunction.CODEC);

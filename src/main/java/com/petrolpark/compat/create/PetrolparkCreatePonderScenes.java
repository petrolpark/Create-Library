...
public class PetrolparkCreatePonderScenes {
    ...
    public static void register(PonderSceneRegistrationHelper<ResourceLocation> helper) {
		...
		if (SharedFeatureFlag.BLENDER.enabled()) {
			itemProviderHelper.addStoryBoard(CreateBlocks.BLENDER, "processing/blender/blending", BlenderScenes::blending);
			if (SharedFeatureFlag.BLOOD.enabled()) itemProviderHelper.addStoryBoard(CreateBlocks.BLENDER, "processing/blender/blood", BlenderScenes::blood);
		};
		...
		if (SharedFeatureFlag.MESH_BASIN.enabled()) itemProviderHelper.forComponents(CreateBlocks.MESH_BASIN)

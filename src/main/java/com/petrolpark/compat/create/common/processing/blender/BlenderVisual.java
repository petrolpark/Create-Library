...
public class BlenderVisual extends SingleAxisRotatingVisual<BlenderBlockEntity> {
    ...
    public BlenderVisual(VisualizationContext context, BlenderBlockEntity blockEntity, float partialTick) {
        super(context, blockEntity, partialTick, Models.partial(PetrolparkPartialModels.BLENDER_COG));

        blades = instancerProvider().instancer(AllInstanceTypes.ROTATING, Models.partial(PetrolparkPartialModels.BLENDER_BLADES))
			.createInstance();

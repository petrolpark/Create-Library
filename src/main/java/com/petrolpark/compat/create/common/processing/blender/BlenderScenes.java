...
import com.petrolpark.client.ponder.instruction.KillEntityInstruction;
...
public class BlenderScenes {
    ...
    public static final void blood(SceneBuilder sceneIn, SceneBuildingUtil util) {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            scene.addInstruction(s -> s.getWorld().getCapability(Capabilities.FluidHandler.BLOCK, basin, null).fill(new FluidStack(PetrolparkCreateFluids.BLOOD.get(), 200), FluidAction.EXECUTE));
        };

...
public class PetrolparkCreateItems {
    ...
    BLOOD_BUCKET = sharedBucketItem(REGISTRATE, SharedFeatureFlag.BLOOD, "blood", () -> PetrolparkCreateFluids.BLOOD)
        .register();
    ...
    public static final ItemEntry<SharedDrinkableFluidContainerItem> EGG_WHITE_BOTTLE = REGISTRATE.sharedItem(SharedFeatureFlag.EGG_PRODUCTS, "egg_white_bottle", (p, f) -> SharedDrinkableFluidContainerItem.sharedDrinkableBottle(f, () -> PetrolparkCreateFluids.EGG_WHITE.get().getSource(), p))
        .fluidCapability(FluidContainerItem::provideCapability)
        .defaultModel()
        .properties(p -> p
            .food(PetrolparkFoods.EGG_WHITE)

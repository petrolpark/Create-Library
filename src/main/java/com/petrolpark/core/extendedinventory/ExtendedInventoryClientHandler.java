...
//         refreshClientInventoryMenu(inv);
//         if (packet.requestFullState) DestroyMessages.sendToServer(new RequestInventoryFullStatePacket());
//     };
...
//         if (menu == mc.player.inventoryMenu) DestroyMessages.sendToServer(new RequestInventoryFullStatePacket()); // Just in case

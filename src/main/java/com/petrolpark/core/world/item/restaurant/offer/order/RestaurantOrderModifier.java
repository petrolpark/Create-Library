...
public class RestaurantOrderModifier implements LootContextUser {

    public static final Codec<RestaurantOrderModifier> CODEC = Codec.lazyInitialized(() -> RecordCodecBuilder.create(instance -> 
        instance.group(
            ItemAdvancedIngredient.CODEC.optionalFieldOf("requirement", PassAdvancedIngredient.INSTANCE).forGetter(RestaurantOrderModifier::getAdvancedIngredient),
            NumberProviders.CODEC.fieldOf("success").forGetter(RestaurantOrderModifier::getSuccessMultiplier),
            NumberProviders.CODEC.optionalFieldOf("failure", ConstantValue.exactly(0f)).forGetter(RestaurantOrderModifier::getFailureNumberProvider)
    ...
    public RestaurantOrderModifier(IAdvancedIngredient<? super ItemStack> ingredient, NumberProvider successMultiplier, NumberProvider failureMultiplier) {

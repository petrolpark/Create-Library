...
public interface IScratchExpression<CONTEXT extends IScratchContext, RETURN_TYPE, PARAMETERS extends ScratchParameters<? super CONTEXT>, EXPRESSION extends IScratchExpression<? super CONTEXT, ? super RETURN_TYPE, ? super PARAMETERS, ?>> extends IScratchSymbol<CONTEXT, PARAMETERS> {

...
public class IfBlock<ENVIRONMENT extends IScratchEnvironment> extends UnaryNestedProcedureBlock<ENVIRONMENT, Boolean, ExpressionOrDropdownArgument<ENVIRONMENT, Boolean>, SimpleNestedProcedureBlockInstance<ENVIRONMENT>, IfBlock<ENVIRONMENT>> {
    ...
    public static final IScratchBlock.Type<IfBlock<?>> TYPE = new FlexibleEnvironmentScratchBlockType<>(IScratchEnvironment.class, IfBlock::create);
    ...
    protected static final <ENVIRONMENT extends IScratchEnvironment> IfBlock<ENVIRONMENT> create(IScratchEnvironment.Type<ENVIRONMENT> environmentType) {

...
public class GoldHelper {
    ...
    public static final void onRegisterGoldBlockConversions(RegisterGoldBlockConversionEvent event) {
        register(event, "impossible", Conversion.dontConvert(PetrolparkTags.Blocks.CANNOT_CONVERT_TO_GOLD::matches), 20000);

        register(event, "metal_blocks", Conversion.convertTaggedBlock(BlockTags.BEACON_BASE_BLOCKS, Blocks.GOLD_BLOCK), 2500);
        ...
        register(event, "polished_blocks", Conversion.convertBlockIdRegex("polished_.+", Blocks.GOLD_BLOCK), 2000); // Doesn't include polished stairs, walls, etc
        ...
        if (Mods.SUPPLEMENTARIES.isLoaded()) {
            ...
            register(event, "supplementaries/bars", Conversion.convertBlockIdRegex(".*bars.*", BlockHelper.supplier(Mods.SUPPLEMENTARIES.asResource("gold_bars"))), 3000);
            register(event, "supplementaries/doors", Conversion.convertTaggedBlockChildren(BlockTags.DOORS, Mods.SUPPLEMENTARIES.asResource("gold_door")), 3000);
            register(event, "supplementaries/trapdoors", Conversion.convertTaggedBlockChildren(BlockTags.TRAPDOORS, Mods.SUPPLEMENTARIES.asResource("gold_trapdoor")), 4000);
        };
    };
